...
|---------------------|-----------------------------------------------------|----------------------------|
| `Wholesale.csv`     | Spending patterns of wholesale customers across product categories | Clustering (K-Means, DBSCAN) |
| `car_insurance.csv` | Attributes of car insurance customers               | Dimensionality reduction (PCA) |
